...
HD_PWD='C:/Users/yelar/Desktop/cpu/cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_cpu_disp2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_cpu_disp2.tcl -notrace
