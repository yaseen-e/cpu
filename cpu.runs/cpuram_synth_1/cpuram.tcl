...
OPTRACE "cpuram_synth_1" START { ROLLUP_AUTO }
...
synth_design -top cpuram -part xc7s50csga324-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp cpuram.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips cpuram]
 }
