...
HD_PWD='C:/Chirag/Winter24/EGR426/Projects/Project3_Mar21/cpu/cpu.runs/cpuram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpuram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpuram.tcl
