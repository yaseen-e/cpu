...
HD_PWD='C:/Users/yelar/Desktop/cpu/cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_cpu_disp2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_cpu_disp2.tcl
