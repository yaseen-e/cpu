...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot cpuram xil_defaultlib.cpuram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cpuram -key {Behavioral:sim_1:Functional:cpuram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpuram.wdb xsim.dir libdpi.so)
