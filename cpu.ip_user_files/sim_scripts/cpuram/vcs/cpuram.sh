...
#
# Script generated by Vivado on Sun Mar 10 20:12:15 -0400 2024
...
#
# Usage        : cpuram.sh
#                cpuram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cpuram.sh [-reset_run]
#                cpuram.sh [-reset_log]
#                cpuram.sh [-help]
#
...
#                script (type 'cpuram.sh -help' for more information).
#
...
# script info
echo -e "cpuram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cpuram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cpuram xil_defaultlib.glbl -o cpuram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cpuram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cpuram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cpuram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cpuram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cpuram.sh [-help]\n\
Usage: cpuram.sh [-step]\n\
Usage: cpuram.sh [-lib_map_path]\n\
Usage: cpuram.sh [-reset_run]\n\
Usage: cpuram.sh [-reset_log]\n\
Usage: cpuram.sh [-keep_index]\n\
Usage: cpuram.sh [-noclean_files]\n\n\
